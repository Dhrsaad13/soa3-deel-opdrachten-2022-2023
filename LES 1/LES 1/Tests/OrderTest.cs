...
namespace Deelopdrachten.Tests
{
    ...
    public class OrderTests
    {
        ...
        public void CalculatePriceTest()
        {
            ...
            Order order = new Order(1, true, new List<Movieticket> { ticket1, ticket2, ticket3 });
        ...
        public void ExportTest()
        {
            ...
            // Maak een nieuwe Order aan met de gemaakte tickets
            Order order = new Order(1, true, new List<Movieticket> { ticket1, ticket2 });
        ...
        {
            [TestMethod()]
            public void IsPremiumTicketTest()
            {
                // Aanmaken van tickets
                Movieticket ticket1 = new Movieticket(1, 1, false);
